...
const router = Router();
import {getProductsLimit,getProductsPage,logOut,getProductsLimit10,postProductsSave,putProducts,deleteProducts} from '../controllers/products.controller.js'
...
router.delete('/:pid2', deleteProducts);
